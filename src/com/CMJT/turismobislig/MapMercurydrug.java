 ...
 * 
 */
public class MapMercurydrug extends FragmentActivity implements
	...
	private static final LatLng mercury = new LatLng(8.18771, 126.35506);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapMercurydrug.this, cls);
			...
			// Creating a LatLng object for the Mercury Drug location
			latLng1 = new LatLng(8.18771, 126.35506);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapMercurydrug.this.getDirectionsUrl(origin,
							dest);
			...
			// Getting URL to the Google Directions API
			String url = MapMercurydrug.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapMercurydrug.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapMercurydrug.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapMercurydrug.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapMercurydrug.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapMercurydrug.this.mMap.addPolyline(lineOptions);
		}
	}
