 ...
 * 
 */
public class MapStFrancisHotel extends FragmentActivity implements
	...
	private static final LatLng StFrancis = new LatLng(8.18812, 126.35519);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapStFrancisHotel.this, cls);
			...
			// Creating a LatLng object for the St Francis Hotel location
			latLng1 = new LatLng(8.18812, 126.35519);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					LatLng dest = StFrancis;

					// Getting URL to the Google Directions API
					String url = MapStFrancisHotel.this.getDirectionsUrl(
							origin, dest);
			...
			// Getting URL to the Google Directions API
			String url = MapStFrancisHotel.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapStFrancisHotel.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapStFrancisHotel.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapStFrancisHotel.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapStFrancisHotel.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapStFrancisHotel.this.mMap.addPolyline(lineOptions);
		}
	}
