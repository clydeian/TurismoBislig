 ...
 * 
 */
public class MapVanForHire extends FragmentActivity implements
	...
	private static final LatLng Van = new LatLng(8.18549, 126.35147);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapVanForHire.this, cls);
			...
			// Creating a LatLng object for the Van Terminal location
			latLng1 = new LatLng(8.18549, 126.35147);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapVanForHire.this.getDirectionsUrl(origin,
							dest);
			...
			// Getting URL to the Google Directions API
			String url = MapVanForHire.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapVanForHire.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapVanForHire.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapVanForHire.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapVanForHire.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapVanForHire.this.mMap.addPolyline(lineOptions);
		}
	}
