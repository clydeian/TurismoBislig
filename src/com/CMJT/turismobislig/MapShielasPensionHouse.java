 ...
 * 
 */
public class MapShielasPensionHouse extends FragmentActivity implements
	...
	private static final LatLng Shielas = new LatLng(8.18585, 126.35667);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapShielasPensionHouse.this, cls);
			...
			// Creating a LatLng object for the Shielas PEnsion House location
			latLng1 = new LatLng(8.18585, 126.35667);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapShielasPensionHouse.this.getDirectionsUrl(
							origin, dest);
			...
			// Getting URL to the Google Directions API
			String url = MapShielasPensionHouse.this.getDirectionsUrl(origin,
					dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapShielasPensionHouse.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapShielasPensionHouse.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapShielasPensionHouse.this.getBaseContext(),
						"You are out of navigation bounds", Toast.LENGTH_SHORT).show();
				return;
			}
			...
			if (mMode == MODE_DRIVING)
				MapShielasPensionHouse.this.tvDistanceDuration
			...
			poly = MapShielasPensionHouse.this.mMap.addPolyline(lineOptions);
		}
	}
