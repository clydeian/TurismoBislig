 ...
 * 
 */
public class MapTinuyanFalls extends FragmentActivity implements
	...
	private static final LatLng TinuyanFalls = new LatLng(8.17141, 126.22948);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapTinuyanFalls.this, cls);
			...
			latLng1 = new LatLng(8.17141, 126.22948);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					LatLng dest = TinuyanFalls;

					// Getting URL to the Google Directions API
					String url = MapTinuyanFalls.this.getDirectionsUrl(origin,
							dest);
			...
			// Getting URL to the Google Directions API
			String url = MapTinuyanFalls.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapTinuyanFalls.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapTinuyanFalls.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapTinuyanFalls.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapTinuyanFalls.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapTinuyanFalls.this.mMap.addPolyline(lineOptions);
		}
	}
