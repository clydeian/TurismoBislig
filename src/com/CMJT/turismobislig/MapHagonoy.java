 ...
 * 
 */
public class MapHagonoy extends FragmentActivity implements
	...
	private static final LatLng Hagonoy = new LatLng(8.25576, 126.36974);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapHagonoy.this, cls);
			...
			// Creating a LatLng object for the Hagonoy location
			latLng1 = new LatLng(8.25576, 126.36974);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapHagonoy.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapHagonoy.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapHagonoy.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapHagonoy.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapHagonoy.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapHagonoy.this.mMap.addPolyline(lineOptions);
		}
	}
