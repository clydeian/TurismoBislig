 ...
 * 
 */
public class MapOVP extends FragmentActivity implements
	...
	private static final LatLng OVP = new LatLng(8.18335, 126.34250);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapOVP.this, cls);
			...
			// Creating a LatLng object for the OVP location
			latLng1 = new LatLng(8.18335, 126.34250);
			...
			Marker Marker11 = mMap.addMarker(new MarkerOptions()
					...
					.title("Ocean View Park and International Doll House")
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapOVP.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapOVP.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapOVP.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapOVP.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapOVP.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			else if (mMode == MODE_WALKING)
				MapOVP.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			...
			poly = MapOVP.this.mMap.addPolyline(lineOptions);
		}
	}
