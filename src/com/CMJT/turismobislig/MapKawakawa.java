 ...
 * 
 */
public class MapKawakawa extends FragmentActivity implements
	...
	private static final LatLng kawakawa = new LatLng(8.17430, 126.28423);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapKawakawa.this, cls);
			...
			// Creating a LatLng object for the Kawa-kawa location
			latLng1 = new LatLng(8.17430, 126.28423);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					LatLng dest = kawakawa;

					// Getting URL to the Google Directions API
					String url = MapKawakawa.this
			...
			// Getting URL to the Google Directions API
			String url = MapKawakawa.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapKawakawa.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapKawakawa.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapKawakawa.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapKawakawa.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapKawakawa.this.mMap.addPolyline(lineOptions);
		}
	}
