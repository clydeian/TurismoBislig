 ...
 * 
 */
public class MapLandbank extends FragmentActivity implements
	...
	private static final LatLng Landbank = new LatLng(8.18676, 126.35513);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapLandbank.this, cls);
			...
			// Creating a LatLng object for the Landbank location
			latLng1 = new LatLng(8.18676, 126.35513);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					LatLng dest = Landbank;

					// Getting URL to the Google Directions API
					String url = MapLandbank.this
			...
			// Getting URL to the Google Directions API
			String url = MapLandbank.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapLandbank.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapLandbank.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapLandbank.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapLandbank.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapLandbank.this.mMap.addPolyline(lineOptions);
		}
	}
