 ...
 * 
 */
public class MapFlorland extends FragmentActivity implements
	...
	private static final LatLng Florland = new LatLng(8.29237, 126.31583);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapFlorland.this, cls);
			...
			// Creating a LatLng object for the Florland location
			latLng1 = new LatLng(8.29237, 126.31583);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					LatLng dest = Florland;

					// Getting URL to the Google Directions API
					String url = MapFlorland.this
			...
			// Getting URL to the Google Directions API
			String url = MapFlorland.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapFlorland.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapFlorland.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapFlorland.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapFlorland.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapFlorland.this.mMap.addPolyline(lineOptions);
		}
	}
