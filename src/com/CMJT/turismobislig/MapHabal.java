 ...
 * 
 */
public class MapHabal extends FragmentActivity implements
	...
	private static final LatLng Habal = new LatLng(8.18784, 126.35289);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapHabal.this, cls);
			...
			// Creating a LatLng object for the Habal- Habal Lounge location
			latLng1 = new LatLng(8.18784, 126.35289);
			...
			Marker Marker38 = mMap.addMarker(new MarkerOptions()
					.position(new LatLng(8.18784, 126.35289))
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapHabal.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapHabal.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapHabal.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapHabal.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapHabal.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			else if (mMode == MODE_WALKING)
				MapHabal.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			...
			poly = MapHabal.this.mMap.addPolyline(lineOptions);
		}
	}
