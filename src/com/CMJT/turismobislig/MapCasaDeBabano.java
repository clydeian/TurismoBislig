 ...
 * 
 */
public class MapCasaDeBabano extends FragmentActivity implements
	...
	private static final LatLng CasadeBabano = new LatLng(8.18849, 126.35619);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapCasaDeBabano.this, cls);
			...
			// Creating a LatLng object for the Casa de Babano location
			latLng1 = new LatLng(8.18849, 126.35619);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					LatLng dest = CasadeBabano;

					// Getting URL to the Google Directions API
					String url = MapCasaDeBabano.this.getDirectionsUrl(origin,
							dest);
			...
			// Getting URL to the Google Directions API
			String url = MapCasaDeBabano.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapCasaDeBabano.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapCasaDeBabano.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapCasaDeBabano.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapCasaDeBabano.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapCasaDeBabano.this.mMap.addPolyline(lineOptions);
		}
	}
