 ...
 * 
 */
public class MapTheRock extends FragmentActivity implements
	...
	private static final LatLng Rock = new LatLng(8.18602, 126.35662);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapTheRock.this, cls);
			...
			// Creating a LatLng object for the The Rock location
			latLng1 = new LatLng(8.18602, 126.35662);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapTheRock.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapTheRock.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapTheRock.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapTheRock.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapTheRock.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapTheRock.this.mMap.addPolyline(lineOptions);
		}
	}
