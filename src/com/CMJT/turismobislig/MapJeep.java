 ...
 * 
 */
public class MapJeep extends FragmentActivity implements
	...
	private static final LatLng Jeep = new LatLng(8.18915, 126.35417);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapJeep.this, cls);
			...
			// Creating a LatLng object for the Jeep Terminal location
			latLng1 = new LatLng(8.18915, 126.35417);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapJeep.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapJeep.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapJeep.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapJeep.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapJeep.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			else if (mMode == MODE_WALKING)
				MapJeep.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			...
			poly = MapJeep.this.mMap.addPolyline(lineOptions);
		}
	}
