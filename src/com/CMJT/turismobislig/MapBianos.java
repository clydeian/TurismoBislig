 ...
 * 
 */
public class MapBianos extends FragmentActivity implements
	...
	private static final LatLng Tyfanny = new LatLng(8.18851, 126.35574);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapBianos.this, cls);
			...
			// Creating a LatLng object for the Bianos location
			latLng1 = new LatLng(8.18851, 126.35574);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapBianos.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapBianos.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapBianos.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapBianos.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapBianos.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapBianos.this.mMap.addPolyline(lineOptions);
		}
	}
