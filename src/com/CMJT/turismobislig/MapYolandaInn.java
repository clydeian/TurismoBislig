 ...
 * 
 */
public class MapYolandaInn extends FragmentActivity implements
	...
	private static final LatLng Yolanda = new LatLng(8.18147, 126.36100);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapYolandaInn.this, cls);
			...
			// Creating a LatLng object for the Yolanda Inn location
			latLng1 = new LatLng(8.18147, 126.36100);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapYolandaInn.this.getDirectionsUrl(origin,
							dest);
			...
			// Getting URL to the Google Directions API
			String url = MapYolandaInn.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapYolandaInn.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapYolandaInn.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapYolandaInn.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapYolandaInn.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapYolandaInn.this.mMap.addPolyline(lineOptions);
		}
	}
