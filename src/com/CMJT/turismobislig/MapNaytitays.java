 ...
 * 
 */
public class MapNaytitays extends FragmentActivity implements
	...
	private static final LatLng naytitays = new LatLng(8.18756, 126.35432);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapNaytitays.this, cls);
			...
			// Creating a LatLng object for the Nay Titay's Kamayan location
			latLng1 = new LatLng(8.18756, 126.35432);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					LatLng dest = naytitays;

					// Getting URL to the Google Directions API
					String url = MapNaytitays.this.getDirectionsUrl(origin,
							dest);
			...
			// Getting URL to the Google Directions API
			String url = MapNaytitays.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapNaytitays.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapNaytitays.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapNaytitays.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapNaytitays.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapNaytitays.this.mMap.addPolyline(lineOptions);
		}
	}
