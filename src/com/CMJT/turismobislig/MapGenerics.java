 ...
 * 
 */
public class MapGenerics extends FragmentActivity implements
	...
	private static final LatLng generics = new LatLng(8.18765, 126.35497);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapGenerics.this, cls);
			...
			// Creating a LatLng object for the Generics Pharmacy location
			latLng1 = new LatLng(8.18765, 126.35497);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					LatLng dest = generics;

					// Getting URL to the Google Directions API
					String url = MapGenerics.this
			...
			// Getting URL to the Google Directions API
			String url = MapGenerics.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapGenerics.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapGenerics.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapGenerics.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapGenerics.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapGenerics.this.mMap.addPolyline(lineOptions);
		}
	}
