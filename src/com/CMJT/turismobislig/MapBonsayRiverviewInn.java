 ...
 * 
 */
public class MapBonsayRiverviewInn extends FragmentActivity implements
	...
	private static final LatLng BonsayInn = new LatLng(8.22126, 126.31555);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapBonsayRiverviewInn.this, cls);
			...
			// Creating a LatLng object for the Bonsay Riverview Inn location
			latLng1 = new LatLng(8.22126, 126.31555);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					LatLng dest = BonsayInn;

					// Getting URL to the Google Directions API
					String url = MapBonsayRiverviewInn.this.getDirectionsUrl(
							origin, dest);
			...
			// Getting URL to the Google Directions API
			String url = MapBonsayRiverviewInn.this.getDirectionsUrl(origin,
					dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapBonsayRiverviewInn.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapBonsayRiverviewInn.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapBonsayRiverviewInn.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapBonsayRiverviewInn.this.tvDistanceDuration
						.setText("Distance:" + distance + ", Duration:"
								+ duration);
			else if (mMode == MODE_WALKING)
				MapBonsayRiverviewInn.this.tvDistanceDuration
						.setText("Distance:" + distance + ", Duration:"
			...
			poly = MapBonsayRiverviewInn.this.mMap.addPolyline(lineOptions);
		}
	}
	...
	public void onMyLocationChange(Location location) {
		...
		allMarkersMap.put(myMarker, Accomodations.class);
