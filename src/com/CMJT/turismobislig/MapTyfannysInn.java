 ...
 * 
 */
public class MapTyfannysInn extends FragmentActivity implements
	...
	private static final LatLng TyfannysInn = new LatLng(8.18693, 126.35399);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapTyfannysInn.this, cls);
			...
			// Creating a LatLng object for the Tyfannys Inn location
			latLng1 = new LatLng(8.18693, 126.35399);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					LatLng dest = TyfannysInn;

					// Getting URL to the Google Directions API
					String url = MapTyfannysInn.this.getDirectionsUrl(origin,
							dest);
			...
			// Getting URL to the Google Directions API
			String url = MapTyfannysInn.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapTyfannysInn.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapTyfannysInn.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapTyfannysInn.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapTyfannysInn.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapTyfannysInn.this.mMap.addPolyline(lineOptions);
		}
	}
