...
public class MapBisligbaywalk extends FragmentActivity implements
	...
	private static final LatLng BisligBaywalk = new LatLng(8.20930, 126.32237);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapBisligbaywalk.this, cls);
			...
			// Creating a LatLng object for the baywalk location
			latLng1 = new LatLng(8.20930, 126.32237);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					LatLng dest = BisligBaywalk;

					// Getting URL to the Google Directions API
					String url = MapBisligbaywalk.this.getDirectionsUrl(origin,
							dest);
			...
			// Getting URL to the Google Directions API
			String url = MapBisligbaywalk.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapBisligbaywalk.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapBisligbaywalk.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapBisligbaywalk.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapBisligbaywalk.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapBisligbaywalk.this.mMap.addPolyline(lineOptions);
		}
	}
