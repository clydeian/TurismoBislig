 ...
 * 
 */
public class MapPLS extends FragmentActivity implements
	...
	private static final LatLng PLS = new LatLng(8.18132, 126.35590);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapPLS.this, cls);
			...
			// Creating a LatLng object for the Pensione La Salle location
			latLng1 = new LatLng(8.18132, 126.35590);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapPLS.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapPLS.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapPLS.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapPLS.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapPLS.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			else if (mMode == MODE_WALKING)
				MapPLS.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			...
			poly = MapPLS.this.mMap.addPolyline(lineOptions);
		}
	}
