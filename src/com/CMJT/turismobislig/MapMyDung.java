 ...
 * 
 */
public class MapMyDung extends FragmentActivity implements
	...
	private static final LatLng MyDung = new LatLng(8.18814, 126.35558);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapMyDung.this, cls);
			...
			latLng1 = new LatLng(8.18814, 126.35558);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapMyDung.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapMyDung.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapMyDung.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapMyDung.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapMyDung.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapMyDung.this.mMap.addPolyline(lineOptions);
		}
	}
