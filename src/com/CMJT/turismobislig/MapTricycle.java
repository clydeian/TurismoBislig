 ...
 * 
 */
public class MapTricycle extends FragmentActivity implements
	...
	private static final LatLng Tricycle = new LatLng(8.18744, 126.35244);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapTricycle.this, cls);
			...
			// Creating a LatLng object for the Tricycle location
			latLng1 = new LatLng(8.18744, 126.35244);
			...
			Marker Marker39 = mMap.addMarker(new MarkerOptions()
					.position(new LatLng(8.18744, 126.35244))
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					LatLng dest = Tricycle;

					// Getting URL to the Google Directions API
					String url = MapTricycle.this
			...
			// Getting URL to the Google Directions API
			String url = MapTricycle.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapTricycle.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapTricycle.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapTricycle.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapTricycle.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapTricycle.this.mMap.addPolyline(lineOptions);
		}
	}
