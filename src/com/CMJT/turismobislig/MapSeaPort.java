 ...
 * 
 */
public class MapSeaPort extends FragmentActivity implements
	...
	private static final LatLng Seaport = new LatLng(8.18876, 126.35273);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapSeaPort.this, cls);
			...
			// Creating a LatLng object for the Sea Port location
			latLng1 = new LatLng(8.18876, 126.35273);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapSeaPort.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapSeaPort.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapSeaPort.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapSeaPort.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapSeaPort.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapSeaPort.this.mMap.addPolyline(lineOptions);
		}
	}
