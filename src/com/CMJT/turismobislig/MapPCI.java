 ...
 * 
 */
public class MapPCI extends FragmentActivity implements
	...
	private static final LatLng PCI = new LatLng(8.18535, 126.35956);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapPCI.this, cls);
			...
			// Creating a LatLng object for the Paper Country Inn location
			latLng1 = new LatLng(8.18535, 126.35956);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapPCI.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapPCI.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapPCI.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapPCI.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapPCI.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			else if (mMode == MODE_WALKING)
				MapPCI.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			...
			poly = MapPCI.this.mMap.addPolyline(lineOptions);
		}
	}
