 ...
 * 
 */
public class MapDansGrill extends FragmentActivity implements
	...
	private static final LatLng DansGrill = new LatLng(8.18748, 126.35545);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapDansGrill.this, cls);
			...
			// Creating a LatLng object for the Dans Grill location
			latLng1 = new LatLng(8.18748, 126.35545);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					LatLng dest = DansGrill;

					// Getting URL to the Google Directions API
					String url = MapDansGrill.this.getDirectionsUrl(origin,
							dest);
			...
			// Getting URL to the Google Directions API
			String url = MapDansGrill.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapDansGrill.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapDansGrill.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapDansGrill.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapDansGrill.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapDansGrill.this.mMap.addPolyline(lineOptions);
		}
	}
