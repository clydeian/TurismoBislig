 ...
 * 
 */
public class MapViolysPensionHouse extends FragmentActivity implements
	...
	private static final LatLng Violys = new LatLng(8.17600, 126.35871);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapViolysPensionHouse.this, cls);
			...
			// Creating a LatLng object for the Violys Pension House location
			latLng1 = new LatLng(8.17600, 126.35871);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapViolysPensionHouse.this.getDirectionsUrl(
							origin, dest);
			...
			// Getting URL to the Google Directions API
			String url = MapViolysPensionHouse.this.getDirectionsUrl(origin,
					dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapViolysPensionHouse.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapViolysPensionHouse.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapViolysPensionHouse.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapViolysPensionHouse.this.tvDistanceDuration
			...
			poly = MapViolysPensionHouse.this.mMap.addPolyline(lineOptions);
		}
	}
