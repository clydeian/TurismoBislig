 ...
 * 
 */
public class MapGails extends FragmentActivity implements
	...
	private static final LatLng Gails = new LatLng(8.18842, 126.35542);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapGails.this, cls);
			...
			// Creating a LatLng object for the Tyfanny location
			latLng1 = new LatLng(8.18842, 126.35542);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapGails.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapGails.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapGails.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapGails.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapGails.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			else if (mMode == MODE_WALKING)
				MapGails.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			...
			poly = MapGails.this.mMap.addPolyline(lineOptions);
		}
	}
