 ...
 * 
 */
public class MapTonys extends FragmentActivity implements
	...
	private static final LatLng tonys = new LatLng(8.18734, 126.35460);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapTonys.this, cls);
			...
			latLng1 = new LatLng(8.18734, 126.35460);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapTonys.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapTonys.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapTonys.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapTonys.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapTonys.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			else if (mMode == MODE_WALKING)
				MapTonys.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			...
			poly = MapTonys.this.mMap.addPolyline(lineOptions);
		}
	}
