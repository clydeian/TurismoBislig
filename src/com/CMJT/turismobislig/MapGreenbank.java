 ...
 * 
 */
public class MapGreenbank extends FragmentActivity implements
	...
	private static final LatLng green = new LatLng(8.18617, 126.35637);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapGreenbank.this, cls);
			...
			// Creating a LatLng object for the Green Bank location
			latLng1 = new LatLng(8.18617, 126.35637);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapGreenbank.this.getDirectionsUrl(origin,
							dest);
			...
			// Getting URL to the Google Directions API
			String url = MapGreenbank.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapGreenbank.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapGreenbank.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapGreenbank.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapGreenbank.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapGreenbank.this.mMap.addPolyline(lineOptions);
		}
	}
