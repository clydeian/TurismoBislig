 ...
 * 
 */
public class MapTyfanny extends FragmentActivity implements
	...
	private static final LatLng Tyfanny = new LatLng(8.18706, 126.35402);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapTyfanny.this, cls);
			...
			latLng1 = new LatLng(8.18706, 126.35402);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapTyfanny.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapTyfanny.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapTyfanny.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapTyfanny.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapTyfanny.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapTyfanny.this.mMap.addPolyline(lineOptions);
		}
	}
