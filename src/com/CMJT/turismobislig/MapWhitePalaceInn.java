 ...
 * 
 */
public class MapWhitePalaceInn extends FragmentActivity implements
	...
	private static final LatLng WhitePalace = new LatLng(8.18326, 126.33768);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapWhitePalaceInn.this, cls);
			...
			// Creating a LatLng object for the White Palace Inn location
			latLng1 = new LatLng(8.18326, 126.33768);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					LatLng dest = WhitePalace;

					// Getting URL to the Google Directions API
					String url = MapWhitePalaceInn.this.getDirectionsUrl(
							origin, dest);
			...
			// Getting URL to the Google Directions API
			String url = MapWhitePalaceInn.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapWhitePalaceInn.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapWhitePalaceInn.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapWhitePalaceInn.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapWhitePalaceInn.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapWhitePalaceInn.this.mMap.addPolyline(lineOptions);
		}
	}
