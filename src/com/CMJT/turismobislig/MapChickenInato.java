 ...
 * 
 */
public class MapChickenInato extends FragmentActivity implements
	...
	private static final LatLng Tyfanny = new LatLng(8.18548, 126.35772);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapChickenInato.this, cls);
			...
			// Creating a LatLng object for the Chicken Inato location
			latLng1 = new LatLng(8.18548, 126.35772);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapChickenInato.this.getDirectionsUrl(origin,
							dest);
			...
			// Getting URL to the Google Directions API
			String url = MapChickenInato.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapChickenInato.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapChickenInato.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapChickenInato.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapChickenInato.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapChickenInato.this.mMap.addPolyline(lineOptions);
		}
	}
