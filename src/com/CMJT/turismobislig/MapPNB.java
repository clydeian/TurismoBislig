 ...
 * 
 */
public class MapPNB extends FragmentActivity implements
	...
	private static final LatLng PNB = new LatLng(8.18782, 126.35522);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapPNB.this, cls);
			...
			// Creating a LatLng object for the PNB location
			latLng1 = new LatLng(8.18782, 126.35522);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapPNB.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapPNB.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapPNB.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapPNB.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapPNB.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			else if (mMode == MODE_WALKING)
				MapPNB.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			...
			poly = MapPNB.this.mMap.addPolyline(lineOptions);
		}
	}
