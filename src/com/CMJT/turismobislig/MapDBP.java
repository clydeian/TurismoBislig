 ...
 * 
 */
public class MapDBP extends FragmentActivity implements
	...
	private static final LatLng DBP = new LatLng(8.18753, 126.35553);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapDBP.this, cls);
			...
			// Creating a LatLng object for the DBP location
			latLng1 = new LatLng(8.18753, 126.35553);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapDBP.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapDBP.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapDBP.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapDBP.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapDBP.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			else if (mMode == MODE_WALKING)
				MapDBP.this.tvDistanceDuration.setText("Distance:" + distance
						+ ", Duration:" + duration);
			...
			poly = MapDBP.this.mMap.addPolyline(lineOptions);
		}
	}
