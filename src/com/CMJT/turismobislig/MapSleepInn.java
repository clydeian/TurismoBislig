 ...
 * 
 */
public class MapSleepInn extends FragmentActivity implements
	...
	private static final LatLng SleepInn = new LatLng(8.18743, 126.35393);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapSleepInn.this, cls);
			...
			// Creating a LatLng object for the Sleep Inn location
			latLng1 = new LatLng(8.18743, 126.35393);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					LatLng dest = SleepInn;

					// Getting URL to the Google Directions API
					String url = MapSleepInn.this
			...
			// Getting URL to the Google Directions API
			String url = MapSleepInn.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapSleepInn.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapSleepInn.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapSleepInn.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapSleepInn.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapSleepInn.this.mMap.addPolyline(lineOptions);
		}
	}
