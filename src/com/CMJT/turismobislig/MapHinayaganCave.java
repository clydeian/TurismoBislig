 ...
 * 
 */
public class MapHinayaganCave extends FragmentActivity implements
	...
	private static final LatLng HinayaganCave = new LatLng(8.29672, 126.37119);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapHinayaganCave.this, cls);
			...
			// Creating a LatLng object for the hinayagancave location
			latLng1 = new LatLng(8.29672, 126.37119);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					LatLng dest = HinayaganCave;

					// Getting URL to the Google Directions API
					String url = MapHinayaganCave.this.getDirectionsUrl(origin,
							dest);
			...
			// Getting URL to the Google Directions API
			String url = MapHinayaganCave.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapHinayaganCave.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapHinayaganCave.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapHinayaganCave.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapHinayaganCave.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapHinayaganCave.this.mMap.addPolyline(lineOptions);
		}
	}
