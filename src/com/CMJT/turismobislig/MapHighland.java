 ...
 * 
 */
public class MapHighland extends FragmentActivity implements
	...
	private static final LatLng Highland = new LatLng(8.18107, 126.35754);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapHighland.this, cls);
			...
			// Creating a LatLng object for the Highland location
			latLng1 = new LatLng(8.18107, 126.35754);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					LatLng dest = Highland;

					// Getting URL to the Google Directions API
					String url = MapHighland.this
			...
			// Getting URL to the Google Directions API
			String url = MapHighland.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapHighland.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapHighland.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapHighland.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapHighland.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapHighland.this.mMap.addPolyline(lineOptions);
		}
	}
