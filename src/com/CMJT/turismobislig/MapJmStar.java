 ...
 * 
 */
public class MapJmStar extends FragmentActivity implements
	...
	private static final LatLng JmStar = new LatLng(8.18812, 126.35599);
		...
		if (status != ConnectionResult.SUCCESS) { // Google Play Services are
			...
			mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent = new Intent(MapJmStar.this, cls);
			...
			// Creating a LatLng object for the JmStar location
			latLng1 = new LatLng(8.18812, 126.35599);
			...
			rgModes.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup group, int checkedId) {
					...
					String url = MapJmStar.this.getDirectionsUrl(origin, dest);
	...
	private class DownloadTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(MapJmStar.this);
		...
		protected String doInBackground(String... url) {
			...
			try {
				...
				data = MapJmStar.this.downloadUrl(url[0]);
			} catch (Exception e) {
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<List<HashMap<String, String>>> result) {
			...
			if (result.size() < 1) {
				Toast.makeText(MapJmStar.this.getBaseContext(),
			...
			if (mMode == MODE_DRIVING)
				MapJmStar.this.tvDistanceDuration.setText("Distance:"
			...
			poly = MapJmStar.this.mMap.addPolyline(lineOptions);
		}
	}
